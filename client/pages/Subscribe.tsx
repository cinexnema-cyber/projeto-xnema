        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Acesse todo o catálogo premium da XNEMA com qualidade 4K e conteúdo exclusivo
            </p>
            
            {user && (
              <div className="mt-6 p-4 bg-xnema-surface rounded-lg inline-block">
                <p className="text-foreground">
                  Bem-vindo, <span className="font-semibold text-xnema-orange">{user.name}</span>! 
            ...
            {plans.map((plan, index) => (
              <Card 
                ...
                className={`relative transition-all hover:scale-105 ${
                  plan.popular ? 'border-2 border-xnema-orange shadow-2xl' : 'border-xnema-border'
                }`}
              >
                {plan.popular && (
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              ...
              <div className="space-y-3">
                ...
                <h3 className="font-semibold text-foreground">Sem Compromisso</h3>
                <p className="text-sm text-muted-foreground">
          ...
          <div className="max-w-2xl mx-auto mt-20">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-xnema-surface rounded-lg p-6">
                ...
                <p className="text-muted-foreground">
                  O pagamento é processado de forma segura pelo Mercado Pago. Você pode pagar 
                  com cartão de crédito, débito ou PIX. A cobrança é automática todo mês.
                </p>
              </div>
