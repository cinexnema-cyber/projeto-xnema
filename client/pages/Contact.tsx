        ...
        <section className="py-20 bg-gradient-to-br from-xnema-dark to-xnema-surface">
          <div className="max-w-4xl mx-auto px-8 text-center">
            ...
            <p className="text-xl text-gray-300 leading-relaxed mb-8 max-w-3xl mx-auto">
              ...
              para oferecer a melhor experiência possível na XNEMA.
            </p>
          </div>
        </section>
              ...
              {contactMethods.map((method, index) => (
                <Card key={index} className="bg-xnema-surface border-gray-700 text-center">
                  <CardContent className="p-6">
                    ...
                    <p className="text-xnema-orange font-medium mb-2">{method.value}</p>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <p className="text-gray-300 mb-8">
                  Preencha o formulário ao lado e nossa equipe retornará o mais breve possível.
                </p>
                  ...
                  <div>
                    ...
                    <Select value={formData.category} onValueChange={(value) => handleInputChange("category", value)}>
                      ...
                      <SelectContent className="bg-xnema-surface border-gray-700">
                        ...
                        <SelectItem value="billing">Billing & Assinaturas</SelectItem>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <Card className="bg-xnema-surface border-gray-700">
                    <CardContent className="p-4">
                      ...
                      <p className="text-sm text-gray-400">
                        Nossa assinatura dá acesso total a todo catálogo por R$ 19,90/mês, 
                        com 7 dias grátis para novos usuários.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-xnema-surface border-gray-700">
                    <CardContent className="p-4">
                      ...
                      <p className="text-sm text-gray-400">
                        Cada conta permite até 4 perfis e 2 streams simultâneos para 
                        toda a família.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-xnema-surface border-gray-700">
                    <CardContent className="p-4">
                      ...
                      <p className="text-sm text-gray-400">
                        Criadores podem submeter propostas através do portal de criadores 
                        ou enviando email para criadores@xnema.com.br
                      </p>
                    </CardContent>
                  </Card>
                </div>
                ...
                <div className="mt-8 p-6 bg-gradient-to-br from-xnema-orange/10 to-xnema-purple/10 rounded-lg border border-xnema-orange/20">
                  <h4 className="font-semibold mb-2 text-xnema-orange">Suporte Urgente</h4>
                  <p className="text-sm text-gray-300 mb-4">
                    Para questões críticas relacionadas a pagamentos ou problemas técnicos graves:
                  </p>
