    ...
    return (
      <Card className="w-full">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">Assine para acessar os filmes!</CardTitle>
          <CardDescription className="text-lg">
        ...
        <CardContent className="text-center space-y-4">
          <p className="text-muted-foreground">
            Olá, <span className="font-semibold text-xnema-orange">{user.name}</span>! 
          ...
          <div className="grid md:grid-cols-3 gap-4 my-6">
            ...
            <div className="text-center p-4 bg-gradient-to-br from-xnema-orange/20 to-xnema-purple/20 border border-xnema-orange rounded-lg">
              <h4 className="font-semibold text-foreground mb-2">Intermediário</h4>
              <p className="text-2xl font-bold text-xnema-orange">R$ 59,90</p>
              <p className="text-sm text-muted-foreground">por mês</p>
              <div className="mt-2">
                <span className="text-xs bg-xnema-orange text-black px-2 py-1 rounded-full">POPULAR</span>
              </div>
            </div>
            <div className="text-center p-4 bg-xnema-surface rounded-lg">
