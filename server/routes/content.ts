...
const uploadContentSchema = Joi.object({
  ...
  category: Joi.string().valid('series', 'movie', 'documentary', 'short').required(),
...
export const uploadContent = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    const { title, description, category, tags, thumbnailUrl, videoUrl, duration } = value;
...
export const getCreatorContent = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const creatorId = req.userId;
...
export const updateContentStatus = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const getPendingContent = async (req: AuthenticatedRequest, res: Response) => {
  try {
