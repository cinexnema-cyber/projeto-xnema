...
export default function BetweenHeavenHell() {
  ...
  const seriesInfo = {
    ...
    description: "Uma saga épica que explora os limites entre o bem e o mal, onde anjos e demônios coexistem em um mundo moderno. Acompanhe a jornada de personagens complexos enquanto enfrentam dilemas morais que questionam a própria natureza da humanidade.",
            ...
            <div className="max-w-4xl">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-lg font-semibold text-foreground">{seriesInfo.rating}</span>
                </div>
              </div>
        ...
        <section className="py-20 bg-xnema-surface">
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-3 gap-12">
              {/* Cast & Crew */}
              <div>
                <h2 className="text-2xl font-bold text-foreground mb-6">Elenco Principal</h2>
                <div className="space-y-3">
                  {seriesInfo.cast.map((actor, index) => (
                    <div key={index} className="text-muted-foreground">{actor}</div>
                  ))}
                </div>
                
                <h3 className="text-xl font-bold text-foreground mt-8 mb-4">Direção</h3>
                <div className="text-muted-foreground">{seriesInfo.director}</div>
              </div>
              
              {/* Synopsis */}
              <div className="lg:col-span-2">
                <h2 className="text-2xl font-bold text-foreground mb-6">Sinopse</h2>
                <p className="text-muted-foreground leading-relaxed mb-6">
                  Em um mundo onde as fronteiras entre o céu e o inferno se tornam cada vez mais tênues, 
                  "Between Heaven and Hell" nos leva a uma jornada extraordinária através de sete temporadas 
                  repletas de mistério, drama e elementos sobrenaturais.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-6">
                  A série acompanha um grupo de personagens únicos que descobrem estar no centro de uma 
                  batalha milenar entre forças angelicais e demoníacas. Cada temporada revela novas camadas 
                  desta mitologia complexa, explorando temas profundos sobre moralidade, redenção e o que 
                  realmente define nossa humanidade.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  Com produção de alta qualidade e efeitos visuais impressionantes, esta é uma série que 
                  promete redefinir o gênero sobrenatural na televisão brasileira.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Assista ao trailer oficial e mergulhe no universo de Between Heaven and Hell
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  ...
                  onClick={() => window.open('https://youtu.be/-KmVyIbsV0Y', '_blank')}
                >
                  Assistir no YouTube
                </Button>
              </div>
            ...
            <div className="flex flex-wrap justify-center gap-2 mb-12">
              {seasons.map((season) => (
                <Button
                  ...
                  className={selectedSeason === season.number ? "bg-xnema-orange text-black" : ""}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid gap-4">
                {seasons[selectedSeason - 1].episodes.map((episode) => (
                  <div key={episode.number} className="bg-xnema-surface rounded-lg p-6 hover:bg-background transition-colors">
                    <div className="flex items-center justify-between">
                      ...
                      <Button size="sm" className="bg-xnema-orange hover:bg-xnema-orange/90 text-black ml-4">
        ...
        <section className="py-20 bg-gradient-to-r from-xnema-orange to-xnema-purple">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-black/80 mb-8 max-w-2xl mx-auto">
              Siga nosso Instagram oficial para bastidores exclusivos, novidades e conteúdo especial da série.
            </p>
            <Button 
              size="lg" 
              variant="outline" 
