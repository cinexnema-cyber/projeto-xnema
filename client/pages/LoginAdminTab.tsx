...
interface LoginAdminTabProps {
  ...
  setAdminForm: React.Dispatch<React.SetStateAction<{ email: string; password: string }>>;
          ...
          <form onSubmit={handleAdminLogin} className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="grid gap-2">
                <label className="text-sm font-medium text-foreground">Email do Administrador</label>
        ...
        <CardContent className="space-y-6">
          <div className="grid gap-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-semibold text-foreground">Gestão de Usuários</h4>
                <p className="text-sm text-muted-foreground">Administrar assinantes e criadores</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-semibold text-foreground">Aprovação de Conteúdo</h4>
                <p className="text-sm text-muted-foreground">Revisar e aprovar vídeos de criadores</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-semibold text-foreground">Analytics Completo</h4>
                <p className="text-sm text-muted-foreground">Relatórios e métricas da plataforma</p>
              </div>
            </div>
          </div>

          <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
            <h4 className="text-sm font-semibold text-red-500 mb-2">⚠️ Acesso Restrito</h4>
