...
export default function ContentInfo() {
  ...
  const isSubscriber = user?.role === 'subscriber' || user?.role === 'admin' || user?.role === 'creator';
  ...
  useEffect(() => {
    ...
    const loadContent = async () => {
      ...
      const mockContent: ContentData = {
        ...
        description: "Uma série dramática que explora os limites entre o bem e o mal.",
        poster: "https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=400&h=600&fit=crop",
        backdrop: "https://images.unsplash.com/photo-1489599433202-4b02d48ad6bd?w=1920&h=1080&fit=crop",
        rating: 4.8,
        year: "2024",
        ...
        episodes: [
          {
            ...
            season: 1,
            episode: 1,
            thumbnail: "https://images.unsplash.com/photo-1485095329183-d0797cdc5676?w=400&h=225&fit=crop",
          ...
          },
          {
            ...
            season: 1,
            episode: 3,
            thumbnail: "https://images.unsplash.com/photo-1516307365426-bea591f05011?w=400&h=225&fit=crop",
  ...
  const handleWatchClick = (episodeId?: string) => {
    ...
    navigate(`/watch/${content?.id}${episodeId ? `?episode=${episodeId}` : ''}`);
  };
              ...
              <div className="lg:col-span-2">
                <div className="flex items-center gap-4 mb-4">
                  {content.genre.map((g, index) => (
                    <Badge key={index} variant="secondary" className="bg-xnema-orange/20 text-xnema-orange">
                      {g}
                    </Badge>
                  ))}
                ...
                <div className="flex items-center gap-6 mb-6">
                  ...
                  {content.seasons && (
                    <div className="flex items-center gap-2">
                      ...
                      <span>{content.seasons} temporada{content.seasons > 1 ? 's' : ''}</span>
                    </div>
                  )}
                ...
                {!isSubscriber ? (
                  <Card className="bg-xnema-surface border-xnema-border text-center p-12">
                    <CardContent>
                      ...
                      <h3 className="text-2xl font-bold mb-4">Conteúdo Exclusivo para Assinantes</h3>
                      <p className="text-gray-400 mb-6 max-w-md mx-auto">
                        Para assistir aos episódios e acessar todo o catálogo premium, 
                        você precisa ser um assinante XNEMA.
                      </p>
                      <Button 
                        size="lg" 
                        className="bg-xnema-orange hover:bg-xnema-orange/90 text-black"
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between">
                      <h3 className="text-2xl font-bold">Episódios - Temporada {selectedSeason}</h3>
                    ...
                    <div className="grid gap-4">
                      {content.episodes?.filter(ep => ep.season === selectedSeason).map((episode) => (
                        <Card key={episode.id} className="bg-xnema-surface border-xnema-border hover:bg-xnema-surface/80 transition-colors">
                          <CardContent className="p-6">
                            <div className="flex gap-6">
                              <div className="relative group cursor-pointer" onClick={() => handleWatchClick(episode.id)}>
                                <img 
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-400">
                          <li><strong>Direção:</strong> {content.director}</li>
                          <li><strong>Ano:</strong> {content.year}</li>
                          <li><strong>Gênero:</strong> {content.genre.join(', ')}</li>
                          {content.seasons && (
                            <li><strong>Temporadas:</strong> {content.seasons}</li>
                          )}
                        </ul>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mb-4">
                          ...
                          <span className="text-lg font-semibold">{content.rating}/5</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="bg-xnema-surface border-xnema-border">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="p-4 bg-xnema-dark rounded-lg">
                        <h4 className="font-semibold mb-2">Entrevistas do Elenco</h4>
                        <p className="text-sm text-gray-400">
                      ...
                      {!isSubscriber && (
                        <div className="text-center p-8 border-2 border-dashed border-xnema-orange/30 rounded-lg">
                          ...
                          <Button onClick={handleSubscribeClick} className="bg-xnema-orange hover:bg-xnema-orange/90 text-black">
